---
title: "AI for Public Health - How We Integrated AI in 63 Public Health Facilities"
...
The project procured a Dell G5 gaming laptop (32GB GDDR6 RAM, 2TB storage, NVIDIA® GeForce® GTX 1660Ti), to host the application and act as a server. Each site getting one each. The hardware arrived fully setup with requisite software applications and qTrack pre-configured for each site.
...
A typical radiology screening routine for a patient (presenting Chest/TB-related symptoms) is as follows: patient data is captured captured before a scan is taken; X-Ray scan is taken; DICOM images are pushed to qTrack for processing; a report is generated with AI findings; clinical process continues.
